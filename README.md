...
* Servir como histórico de aprendizado e portfólio.
...
```text
deloitte-bootcamp-dotnet/
│
├── dia1/                # Criação da API
├── dia 2/Case 2         # Casos práticos do segundo dia
├── dia_3/               # API de gerenciamento de lotes para uma mina
├── dia4/                # Exercícios de fixação
├── dia5/                # Check-in de Visitantes
├── dia6/                # Melhoras na API 
│   └── Projeto_de_Estudos
├── .gitignore
└── README.md
````
